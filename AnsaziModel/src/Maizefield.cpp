...
void MaizeField::MaizeProduction(int yieldFromFile)
{
    ...
    repast::DoubleUniformGenerator gen2 = repast::Random::instance()->createUniDoubleGenerator(0, sigmaahv+0.01); // initialise random number generator
    q = gen1.next();
    y = yieldFromFile;
    //std::cout<<"sigmaahv"<<gen2.next()<<std::endl; 
