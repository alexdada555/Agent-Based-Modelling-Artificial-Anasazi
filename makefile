...
compile: clean_compiled_files
	...
	$(MPICXX) $(REPAST_HPC_DEFINES) $(BOOST_INCLUDE) $(REPAST_HPC_INCLUDE) -I./include -c ./src/Maizefield.cpp -o ./objects/Maizefield.o
	...
	$(MPICXX) $(BOOST_LIB_DIR) $(REPAST_HPC_LIB_DIR) -o ./bin/main.exe  ./objects/Main.o ./objects/Model.o ./objects/Agent.o ./objects/Maizefield.o $(REPAST_HPC_LIB) $(BOOST_LIBS)
